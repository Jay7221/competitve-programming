...
void dfs(int u, int p){
    ...
    for(int v: adj[u]){
        ...
        diff1 *= (dp[v][1] / modint(2) + dp[v][0] + dp[v][2] * 2) / modint(3);
        ways *= (dp[v][0] * modint(2) + dp[v][1] + dp[v][2] * modint(3)) / modint(3);
        same *= dp[v][2] / modint(3);
    }

    dp[u][1] = modint(6) * (diff1 - same);
    dp[u][2] = modint(3) * (ways - same) - dp[u][1];
    if((int)adj[u].size() == 1){
        dp[u][0] = 3;
    }
